...
class CustomerRequest extends FormRequest
{
    ...
    public function message()
    {
        return [
            ...
            "laste-name.min" => "Le champ doit comporter plus de 2 caractères",
            "first-name.required" => "Le nom est requis !",
            "first-name.string" => "Le champ doit contenir que des lettres",
            "first-name.min" => "Le champ doit comporter plus de 2 caractères",
            "phone.required" => "Le champ téléphoneest requis",
            "email.required" => "Le champs email est requis",
            "email.string" => "Le champ doit comporter une chaîne de cractère",
