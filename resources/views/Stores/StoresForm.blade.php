...
<form method="POST" action="{{-- route('register') --}}">
    ...
    <div class="form-marque">
        <input id="last_name" type="text" class="form-control @error('store_name')is-invalid @enderror" name="store_name" value="{{ old('store_name') }}" requiredautocomplete="store_name" autofocus placeholder="{{ __('Nom') }}">
        @error('store_name')
