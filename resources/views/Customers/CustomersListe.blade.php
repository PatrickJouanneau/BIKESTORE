    ...
    <tbody id="body-customer">
        ...
        @foreach ($customers as $cust)
           <tr>
                ...
                <td>{{  $cust->getPhone() }}</td>
                <td>{{  $cust->getEmail() }}</td>
                <td><a href="{{ url('/home/'.$cust->getCustomerId().'/edit') }}"><img src="img/wrench.svg" alt=""></a>&nbsp;&nbsp;</td>
                <td><a href="{{ url('/home/'.$cust->getCustomerId().'/delete') }}"><img src="img/trash.svg" alt="Poubelle"></a></td>
           </tr>
        @endforeach
    </tbody>
</table>
