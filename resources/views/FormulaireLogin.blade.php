                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    {{ $message ?? ""}}
                                    <form class="user" method="post" action="{{ url('formLogin') }}">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="password" vaclass="form-control form-control-user" id="password" placeholder="Mot de passe">
                                        </div>
